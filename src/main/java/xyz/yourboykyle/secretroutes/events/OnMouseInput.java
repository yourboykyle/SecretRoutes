...
public class OnMouseInput {
    ...
    public static void register() {
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            try {
                ...
                boolean rightClick = mc.mouseHandler.isRightPressed();
    ...
    private static void onMouseClick(LocalPlayer player, int button) {
        try {
            ...
            String itemName = item.getItemName().getString().toLowerCase();
