...
public class ParticleUtils {
    ...
    public static void drawLineParticles(BlockPos loc1, BlockPos loc2, ParticleOptions particle) {
    ...
    public static void drawLineMultipleParticles(ParticleOptions particle, List<BlockPos> locations) {
        if (locations == null) {
            return;
        }
        if (locations.size() >= 2) {
